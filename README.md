...
This project has some edits in package.json which make a proxy for  "http://localhost:8080" which is where the DB server is during development.

This is basically a cleaned up version of https://github.com/mpmckenna8/travelstuff

But still need to add a cleaned up database.
